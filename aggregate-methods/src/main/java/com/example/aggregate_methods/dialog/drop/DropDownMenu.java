...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.drop_down_menu);
        underlineColor = a.getColor(R.styleable.drop_down_menu_drop_line_color, underlineColor);
        dividerColor = a.getColor(R.styleable.drop_down_menu_drop_divider_color, dividerColor);
        textSelectedColor = a.getColor(R.styleable.drop_down_menu_drop_selected_color, textSelectedColor);
        textUnselectedColor = a.getColor(R.styleable.drop_down_menu_drop_unselected_color, textUnselectedColor);
        menuBackgroundColor = a.getColor(R.styleable.drop_down_menu_drop_background_color, menuBackgroundColor);
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_menu_out));
            maskView.setVisibility(GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_alpha_out));
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_menu_in));
                        maskView.setVisibility(VISIBLE);
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_alpha_in));
