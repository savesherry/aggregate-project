...
/**
 * CREATE BY LiYang
 * Transition options, using {@link ActivityTransitionOptions#makeTransitionOptions(Activity, View...)}
...
public class ActivityTransitionOptions {
     ...
     */
    public static ActivityTransitionOptions makeTransitionOptions(Activity activity, View... views) {
