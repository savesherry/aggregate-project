...
public class ConstantPermission {
    ...
    public static int requestPermissionCode = 1000;
     ...
     * 读取外部存储
     *
     * @deprecated 在 Android 11 已经过时，请使用 {@link ConstantPermission#MANAGE_EXTERNAL_STORAGE}
     */
    @Deprecated
    ...
    public static final class Group {
         ...
         * 存储权限
         *
         * @deprecated 在 Android 11 已经过时，请使用 {@link ConstantPermission#MANAGE_EXTERNAL_STORAGE} 权限
         */
        @Deprecated
        public static final String[] STORAGE = new String[]{
                ConstantPermission.READ_EXTERNAL_STORAGE,
                ConstantPermission.WRITE_EXTERNAL_STORAGE};

        /**
         * 语音权限
         */
        public static final String[] SPEECH_SOUNDS = new String[]{
                ConstantPermission.RECORD_AUDIO,
                ConstantPermission.READ_EXTERNAL_STORAGE,
                ConstantPermission.WRITE_EXTERNAL_STORAGE};
        ...
        public static final String[] CALENDAR = new String[]{
                ConstantPermission.READ_CALENDAR,
                ConstantPermission.WRITE_CALENDAR};

        /**
         * 联系人权限
         */
        public static final String[] CONTACTS = new String[]{
                ConstantPermission.READ_CONTACTS,
                ConstantPermission.WRITE_CONTACTS,
                ConstantPermission.GET_ACCOUNTS};

        /**
         * 传感器权限
         */
        public static final String[] SENSORS = new String[]{
                ConstantPermission.BODY_SENSORS,
                ConstantPermission.ACTIVITY_RECOGNITION};
    }
}
