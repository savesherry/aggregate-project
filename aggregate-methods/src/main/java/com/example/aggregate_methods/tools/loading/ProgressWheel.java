...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.progress_wheel_circle_radius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.progress_wheel_fill_radius, false);

        barWidth = (int) a.getDimension(R.styleable.progress_wheel_bar_width, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.progress_wheel_rim_width, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.progress_wheel_spin_speed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.progress_wheel_bar_spin_cycle_time, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.progress_wheel_bar_color, barColor);

        rimColor = a.getColor(R.styleable.progress_wheel_rim_color, rimColor);

        linearProgress = a.getBoolean(R.styleable.progress_wheel_linear_progress, false);

        if (a.getBoolean(R.styleable.progress_wheel_progress_indeterminate, false)) {
            spin();
        }
